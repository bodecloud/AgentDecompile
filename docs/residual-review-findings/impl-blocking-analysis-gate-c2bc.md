...
**HEAD:** `869aed2`+ — merge-blocking CI **green** on `869aed2` (unit, headless 4×, Ghidra extension 4×). **65** unit tests locally. PR **ready to merge**; canonical live `/lfg` e2e remains post-merge (P3).
