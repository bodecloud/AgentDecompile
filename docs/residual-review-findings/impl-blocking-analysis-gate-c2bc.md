...
**HEAD:** `a40ff68`+ — merge-blocking workflows green (unit, headless, Ghidra extension). Latest: structured `analysis-timeout` for provider-raised timeouts (`a40ff68`, review re-raise in base handler).
