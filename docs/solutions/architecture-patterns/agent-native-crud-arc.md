...
symptoms:
  ...
  - Data-type catalog lacked full CRUD in manage-data-types
...
The 2026-05-24 audit listed **strings CRUD**, **catalog CRUD**, and **function-tag set** as remaining gaps across `manage-strings`, `manage-data-types`, and `manage-function-tags`.

## Solution (mega-stack PR #111)

Branch **`impl/crud-mega-stack-c2bc`**. **Ship PR:** [#111](https://github.com/bolabaden/AgentDecompile/pull/111) — supersedes #105–#110 and stale hygiene [#108](https://github.com/bolabaden/AgentDecompile/pull/108).
...
flowchart LR
  ...
  strings --> M[mega-stack #111]
  dtypes --> M
  tags --> M
```

## Audit impact (when #111 merges)
...
- Function-tags set: clear existing tags, then `addTag` each name in one transaction.
