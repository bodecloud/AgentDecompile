...
| `architecture-patterns/` | Coordinators, locking, fail-closed behavior, **tiered RE tool routing**, **capabilities MCP resource** (`capabilities-mcp-resource.md`, `tiered-re-analysis-routing.md`, `tiered-re-analysis-knowledgebase.md`), **variable rename integration test** (`variable-rename-integration-test.md`) |
