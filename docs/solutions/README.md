...
| `architecture-patterns/` | Coordinators, locking, fail-closed behavior, **tiered RE tool routing**, **capabilities MCP resource** (`capabilities-mcp-resource.md`, `tiered-re-analysis-routing.md`, `tiered-re-analysis-knowledgebase.md`), **agent-native discovery arc** (`agent-native-discovery-arc.md`) |
